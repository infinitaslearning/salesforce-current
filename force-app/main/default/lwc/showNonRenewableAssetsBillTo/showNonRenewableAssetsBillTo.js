...
import getAssetListForBillTo from '@salesforce/apex/ASSET_showRenewableAssetsHelper.getNonRenewableAssetListForBillTo';
import getSortedAssetListForBillToJS from '@salesforce/apex/ASSET_showRenewableAssetsHelper.getNonRenewableSortedAssetListForBillTo';
import { pageNumber, pageSize, totalRecords, records } from 'c/paginator';

export default class ShowNonRenewableAssetsBillTo extends LightningElement {
